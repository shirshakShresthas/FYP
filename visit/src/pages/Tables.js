...
const rows = [
  ...
  createData('Drive to Darbang',2, '900 M', '7-9 hrs'),
  createData('Trek to Muri',3, '1234 M', '5-7 hrs'),
  createData('Trek to Italy Base Camp',4,'3013 M', '6hrs'),
  createData('Trek to Glacier Camp',5,'4430 M','4hrs'),
  createData('Trek to Dhaulagiri B. Camp',6, '4740 M', '5hrs'),
];
...
export default function CustomizedTables() {
  ...
  return (
    ...
    <div className="head">
        <h1 className="tree">Dhaulagiri Base Camp Trek Itinerary</h1>
    </div>
